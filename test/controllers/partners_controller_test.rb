...
class PartnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post partners_url, params: { partner: { active: @partner.active, email: @partner.email, name: @partner.name, password: @partner.password, phone_numbers: @partner.phone_numbers } }
    end
  ...
  test "should update partner" do
    patch partner_url(@partner), params: { partner: { active: @partner.active, email: @partner.email, name: @partner.name, password: @partner.password, phone_numbers: @partner.phone_numbers } }
